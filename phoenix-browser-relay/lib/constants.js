/**
 * Shared constants for the Phoenix Browser Relay extension.
 */
...
export const STATE_UI = {
  [RelayState.DISABLED]:     { dotColor: null,      title: 'Phoenix Browser Relay — disabled' },
  [RelayState.DISCONNECTED]: { dotColor: '#F59E0B', title: 'Phoenix Browser Relay — connecting…' },
  [RelayState.CONNECTED]:    { dotColor: '#22C55E', title: 'Phoenix Browser Relay — connected' },
}
