...
export const STATE_UI = {
  [RelayState.DISABLED]:     { dotColor: null,      title: 'LaoLiu Browser Relay — disabled' },
  [RelayState.DISCONNECTED]: { dotColor: '#F59E0B', title: 'LaoLiu Browser Relay — connecting…' },
  [RelayState.CONNECTED]:    { dotColor: '#22C55E', title: 'LaoLiu Browser Relay — connected' },
}
